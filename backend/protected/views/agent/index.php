    ...
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-paper-plane"></i>中介列表
                </div>
             <div class="actions">

					<a class="btn default yellow-stripe" href="<?php echo Yii::app()->createUrl('agent/add') ?>">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">经纪人添加 </span>
					</a>
				</div>
            </div>
...
<script>
    jQuery(document).ready(function () {
        var url = '<?php echo $this->createUrl("agent/index",array('isAjax'=>1))?>';
