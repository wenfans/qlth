                        ...
                        <div id="tab_1" class="tab-pane active">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <tr>
                                        <td width='30%'>头像</td>
                                        <td width='70%'><a href="<?= $profile->avatar?>" target="_blank"><img src="<?php echo $profile->avatar?>" style="width: 50px;height: 50px;"/></a></td>
                                    </tr>
                                    <tr>
                                        <td width='30%'>UID</td>
                                    ...
                                    <tr>
                                        <td width='30%'>认证执照</td>
                                        <td width='70%'><a href="<?php echo $detail->business_card_src;?>" target="_blank"><img src="<?php echo $detail->business_card_src?>" style="width: 50px;height: 50px;"/></a></td>
                                    </tr>
                                    <tr>
                                        <td width='30%'>地址</td>
