                            ...
                            <div class="form-body">
                                <?php if($display=='success'):?>
                                    <div class="form-group">
                                        <?php echo $form->labelEx($model, "经纪人名称<span class='required'>*</span>", array('class' => 'col-md-2 control-label')); ?>
                                        <div class="col-md-8">
                                ...
                                <!--                                从业资格证-->
                                <div class="form-group">
                                    <?php echo $form->labelEx($detail, 'business_card_src', array('class' => 'col-md-2 control-label')); ?>
                                    <div class="col-md-8">
                                        <?php
                                        $this->widget('application.extensions.baiduUeditor.UeditorWidget',
                                            array(
                                    ...
                                    <?php echo $form->error($detail, 'business_card_src'); ?>
                                </div>
                                <!--                                地域-->
                                <div class="form-group">
                                ...
                                <div class="actions btn-set" style="margin:20px 0px 0px 200px;">
                                    ...
                                    <?php else:?>
                                        ...
                                        <button class="btn default" type="button"><a href="<?php echo $this->createUrl('agent/loser',array('uid'=>$model->uid));?>"><i class="fa fa-reply"> 不通过认证</i></a> </button>
                                    <?php endif;?>
                                </div>
                            </div>
                        </div>
