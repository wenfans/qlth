                        ...
                        <div id="tab_1" class="tab-pane active">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <tr>
                                        <td width='30%'>形象照片</td>
                                        <td width='70%'><img src="<?php echo isset($detail->img_src)?$detail->img_src:'';?>" style="width: 50px;height: 50px;"/></td>
                                    </tr>
                                    <tr>
                                        <td width='30%'>用户名</td>
                                    ...
                                    <tr>
                                        <td width='30%'>名片</td>
                                        <td width='70%'> <img src="<?php echo isset($detail->img_src)?$detail->img_src:'';?>" height="200" width="200" alt=""/></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
