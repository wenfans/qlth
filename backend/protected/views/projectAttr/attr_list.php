    ...
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                <div class="caption">
                    <i class="fa fa-child"></i>属性列表
                </div>
                <div class="actions">
                    <a href="<?php echo Yii::app()->createUrl('projectAttr/addAttr/id/'.$model->id)?>" class="btn default yellow-stripe">
                        <i class="fa fa-plus"></i><span class="hidden-480">属性添加 </span>
                    </a>
                </div>
            </div>
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("attribute",array('isAjax'=>1,'id'=>$model->id))?>';
