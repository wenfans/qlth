...
$this->pageTitle = '关于我们';
$this->title = '文章管理<small>关于我们</small>';
?>
<!-- BEGIN PAGE CONTENT-->
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                <div class="caption">
                    <i class="fa fa-paper-plane"></i>关于我们
                </div>
                <div class="actions">

                    <a class="btn default yellow-stripe" href="<?php echo Yii::app()->createUrl('article/aboutadd')?>">
                        <i class="fa fa-plus"></i>
                        <span class="hidden-480">添加关于我们 </span>
                    </a>
                </div>
            </div>
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("about",array('isAjax'=>1))?>';
