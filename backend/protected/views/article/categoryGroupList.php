        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                ...
                <div class="actions">
                    ...
                    <a class="btn default yellow-stripe" href="<?php echo Yii::app()->createUrl('article/CategoryAdd/pid/'.$id)?>">
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("article/CategoryGroupList/id/$id",array('isAjax'=>1))?>';
