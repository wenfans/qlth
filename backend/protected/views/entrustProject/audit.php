                        ...
                        <tr role="row">
                            ...
                            <th width="15%">
                                <select class="form-control form-filter input-sm" name="status">
                                    ...
                                    <option value="<?php echo ProjectModel::STATUS_SUBMIT;?>" ><?php echo ProjectModel::$status_types[ProjectModel::STATUS_SUBMIT];?></option>
                                </select>
                            </th>
                            <th width="15%">
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("/entrustProject/audit",array('isAjax'=>1))?>';
