                ...
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover" id="datatable_list">
                        ...
                        <tr role="row">
                            ...
                            <th width="15%">
                                <select class="form-control form-filter input-sm" name="shelf_type">
                                    <option value="" selected="selected">原因</option>
                                    <option value="<?php echo ProjectModel::SHELF_TYPE_PLATFORM;?>">平台下架</option>
                                    <option value="<?php echo ProjectModel::SHELF_TYPE_USER;?>" >用户下架</option>
                                </select>
                            </th>
                            <th width="15%">
                                <select class="form-control form-filter input-sm" name="status">
                                    <option value="" selected="selected">状态</option>
                                    <option value="<?php echo ProjectModel::STATUS_TRADE_SUCCESS;?>">已成交</option>
                                    <option value="<?php echo ProjectModel::STATUS_SHELF;?>" >已下架</option>
                                </select>
                            </th>
                            <th width="15%">
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("project/".$action,array('isAjax'=>1))?>';
