                        ...
                        <div class="tab-pane active" id="tab_general">
                            <div class="form-body">
                                <div class="form-group">
                                    <?php echo $form->labelEx($model,'服务商名称',array('class'=>'col-md-2 control-label')); ?>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <?php echo $form->labelEx($profile,'真实姓名',array('class'=>'col-md-2 control-label')); ?>
                                    <div class="col-md-8">
                                        <?php echo $form->textField($profile,'identity_name',array('class'=>'form-control')); ?>
                                    </div>
                                    <?php echo $form->error($model,'identity_name'); ?>
                                </div>
                                <div class="form-group">
                                    <?php echo $form->labelEx($profile,'身份证号码：',array('class'=>'col-md-2 control-label')); ?>
                                    <div class="col-md-8">
                                        <?php echo $form->textField($profile,'identity_card',array('class'=>'form-control')); ?>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $this->widget('application.extensions.baiduUeditor.UeditorWidget',
                                            array(
                                                ...
                                                'name'=>'DetailModel[image]',//post到后台接收的name [必须配置]
...
<!--                                地域-->
                                        ...
                                        <?php echo $form->dropDownList($model, 'province_id', CHtml::listData(DistrictModel::model()->findAll('level=1'), 'id', 'name'),
                                            array(
                                                ...
                                                'ajax' => array(
                                                 ...
                                                 $("#ProfileModel_city_id").html(data.cities);
                                                 $("#ProfileModel_district_id").html(data.districts);
                                           }',
                                                )));
                                        ?>
                                        <?php echo $form->dropDownList($model,'city_id',$model->province_id ? CHtml::listData(DistrictModel::model()->findAll('upid='.$model->province_id), 'id', 'name') : array(),
                                            array(
                                                ...
                                                'ajax' => array(
                                                    'type' => 'POST',
                                                    'url' => $this->createUrl('ajax/district'),
                                                    'update' => '#ProfileModel_district_id',
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo $form->textField($detail,'desc',array('class'=>'form-control')); ?>
                                    </div>
