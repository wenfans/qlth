    ...
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                <div class="caption">
                    <i class="fa fa-paper-plane"></i>资产购买方式
                </div>
                <div class="actions">
                    <a class="btn default yellow-stripe" href="<?php echo Yii::app()->createUrl('assetAttributes/create')?>">
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("/assetAttributes/index",array('isAjax'=>1))?>';
