	...
	<div class="col-md-12">
		...
		<div class="portlet">
			<div class="portlet-title form-horizontal">
				<div class="caption">
					<i class="fa fa-paper-plane"></i>派单管理
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" id="datatable_list">
						...
						<tr>
							<th width="20%"> <input class="form-control form-filter input-sm" type="text" name="title" placeholder="资产名称"/> </th>
							<th width="15%"> <input class="form-control form-filter input-sm" type="text" name="projectId" placeholder="资产ID"/> </th>
							<th width="15%"> </th>
							<th width="15%"> </th>
							<th width="15%"> </th>
							<th width="20%">
...
<script>
	jQuery(document).ready(function() {
		var url = '<?php echo $this->createUrl("TaskList",array('isAjax'=>1))?>';
