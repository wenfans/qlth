...
$this->pageTitle = '变现详情';
$this->title = '变现详情<small>变现详情</small>';
?>
                        ...
                        <div id="tab_1" class="tab-pane active">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <?php endif;?>
                                    <?php if($model->state==ProjectUserRecordModel::STATE_CONTACTING):?>
                                        <tr>
                                            <td width='30%'></td>
                                            <td width='70%'>
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("cashinfo",array('id'=>$model->id))?>';
