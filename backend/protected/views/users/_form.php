                    ...
                    <div class="tab-content no-space">
                        <div class="tab-pane active" id="tab_general">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <?php echo $form->labelEx($model,'邮箱',array('class'=>'col-md-2 control-label')); ?>
                                    <div class="col-md-8">
                                        <input class="form-control" name="email" id="User_email" type="email">
                                    </div>
                                    <?php echo $form->error($model,'邮箱'); ?>
                                </div>
                                <div class="form-group">
                                    <?php echo $form->labelEx($model,'密码',array('class'=>'col-md-2 control-label')); ?>
                                    <div class="col-md-8">
                                        <input class="form-control" name="password" id="User_password" type="password">
                                    </div>
