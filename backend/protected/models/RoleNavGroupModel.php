 ...
 */
class RoleNavGroupModel extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, nav_id, is_delete, is_effect, sort', 'required'),
			array('nav_id, is_delete, is_effect, sort', 'numerical', 'integerOnly'=>true),
			array('name, icon', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, nav_id, icon, is_delete, is_effect, sort', 'safe', 'on'=>'search'),
		);
	}
